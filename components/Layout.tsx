    ...
    <div className="flex flex-col min-h-screen bg-slate-900 text-slate-100">
      <header className="bg-slate-800 border-b border-slate-700 px-6 py-4 flex items-center justify-between shadow-lg sticky top-0 z-50">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-bold tracking-tight">TrackPro <span className="text-emerald-400">Coach</span></h1>
        </div>
      </header>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-slate-800/90 backdrop-blur-md border-t border-slate-700 px-4 py-3 md:py-4 z-50">
